package Locked_Me.com;
	...
	public class LockedMeMain {
		...
		static final String folderpath="C:\\Users\\Khale\\eclipse-workspace\\AK\\JavaPhase1\\LockedMeFileList";
		...
		public static void MainMenuDisplay()
		{
			...
			System.out.println("\tDeveloper :- Aanjaneya Khale");
			System.out.println("**********************************************************************");
		...
		public static void getAllFiles()
		{
			...
			List<String> fileNames = FileMgr.getAllFileNames(folderpath);
		...
		public static void addFiles()
		{
			...
			boolean isSaved =FileMgr.addFiles(folderpath, fileName, content);
		...
		public static void deleteFile()
		{
			...
			boolean isDeleted =FileMgr.deleteFile(folderpath, fileName);
		...
		public static void searchFile()
		{
			...
			boolean isExists =FileMgr.searchFile(folderpath, fileName);
